...
describe("submission readiness contract", () => {
  ...
  it("requires typed YouTube video evidence related to the manifest URL", () => {
    const manifest = validManifest();
    manifest.video.publicUrl = "https://youtu.be/conversion-lab-demo";
  ...
  it("accepts complete checkpoint-specific evidence with cross-field relationships", () => {
    const manifest = validManifest();
    manifest.video.publicUrl = "https://www.youtube.com/watch?v=conversion-lab";
    manifest.externalAcceptance = {
      ...
      secondCleanSession: {
        ...
        evidence: {
          ...
          cleanSession: true,
          journeyCompleted: true,
          evidenceUrl: "https://github.com/DG-creative-lab/openai-webmcp-hackathon/issues/2",
        },
      },
      publicVideo: {
        status: "passed",
