...
2. No demo publication without current approval state bound to the exact product target, copy and provenance-bearing evidence digest; do not present the credential-free UI gesture as authenticated merchant authority.
